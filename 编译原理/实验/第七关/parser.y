...
declists : declist declists
         | declist
         ;

declist : ids COLON type SEMICOLON
				;
...
stmt  : ID ASSIGN exp
      | WHILE judge DO BEGINN stmts END
      | IF judge THEN BEGINN stmts END ELSE BEGINN stmts END
      ;
...
stmts : stmt stmt_part           
			;

stmt_part : SEMICOLON stmts
          |
          ;
